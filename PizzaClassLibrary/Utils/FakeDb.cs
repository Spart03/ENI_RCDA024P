...
namespace PizzaClassLibrary.Utils
{
    public class FakeDb
    {
        ...
        private void InitialiserDatas()
        {
            ...
            {
                new Pizza{ Id=1, Nom="Pizza uno", Pate = Pates.ElementAt(1), Ingredients = new List<Ingredient>
                {
                    Ingredients.ElementAt(0),
                    Ingredients.ElementAt(1),
                    Ingredients.ElementAt(4),
                } },
                new Pizza{ Id=2, Nom="Pizza due", Pate = Pates.ElementAt(3), Ingredients = new List<Ingredient>
                {
